...
public class activar extends SelectorComposer<Component> {
	...
	public void onClick$btnGrabar()
		...
		Messagebox.show("Esta seguro de activar el registro?", ".:: Activar categoria ::.",
				Messagebox.OK | Messagebox.CANCEL, Messagebox.QUESTION, new org.zkoss.zk.ui.event.EventListener() {
					...
					public void onEvent(Event event) throws Exception {
						if (event.getName().equals("onOK")) {
							...
							categoria_dn.setId_categoria(activar.this.categoria.getId_categoria());
							categoria_dn.setNom_categoria(activar.this.categoria.getNom_categoria());
							categoria_dn.setDes_categoria(activar.this.categoria.getDes_categoria());
							categoria_dn.setId_localidad(activar.this.categoria.getId_localidad());
							categoria_dn.setMos_capacidad(activar.this.categoria.getMos_capacidad());
							categoria_dn.setMos_fec_inicio(activar.this.categoria.getMos_fec_inicio());
							categoria_dn.setMos_fec_fin(activar.this.categoria.getMos_fec_fin());
							categoria_dn.setMos_tip_respaldo(activar.this.categoria.getMos_tip_respaldo());
							categoria_dn.setMos_id_contenedor(activar.this.categoria.getMos_id_contenedor());
							categoria_dn.setEst_categoria("AE");
							categoria_dn.setUsu_modifica(user);
							java.util.Date date = new Date();
							Timestamp timestamp = new Timestamp(date.getTime());
							categoria_dn.setFec_modifica(timestamp);
							...
							int tipo = 2;
							try {
								dao.modificarCategoria(categoria_dn, solicitud, tipo);
								if (tipo == 2) {
									Messagebox.show("La categoria se activó correctamente.",
											".:: Activar categoria ::.", Messagebox.OK, Messagebox.EXCLAMATION);
								} else {
