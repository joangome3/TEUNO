...
public class desactivar extends SelectorComposer<Component> {
	...
	public void onClick$btnGrabar()
		...
		Messagebox.show("Esta seguro de desactivar el registro?", ".:: Desactivar solicitante ::.",
				Messagebox.OK | Messagebox.CANCEL, Messagebox.QUESTION, new org.zkoss.zk.ui.event.EventListener() {
					...
					public void onEvent(Event event) throws Exception {
						if (event.getName().equals("onOK")) {
							...
							solicitante.setId_solicitante(desactivar.this.solicitante.getId_solicitante());
							solicitante.setId_tip_documento(desactivar.this.solicitante.getId_tip_documento());
							solicitante.setId_empresa(desactivar.this.solicitante.getId_empresa());
							solicitante.setNum_documento(desactivar.this.solicitante.getNum_documento());
							solicitante.setNom_solicitante(desactivar.this.solicitante.getNom_solicitante());
							solicitante.setApe_solicitante(desactivar.this.solicitante.getApe_solicitante());
							solicitante.setEst_solicitante("IE");
							...
							try {
								...
								if (tipo == 2) {
									Messagebox.show("La solicitante se desactivó correctamente.",
											".:: Desactivar solicitante ::.", Messagebox.OK, Messagebox.EXCLAMATION);
								} else {
