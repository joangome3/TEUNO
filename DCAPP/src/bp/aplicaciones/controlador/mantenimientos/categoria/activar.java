				...
				Messagebox.OK | Messagebox.CANCEL, Messagebox.QUESTION, new org.zkoss.zk.ui.event.EventListener() {
					...
					public void onEvent(Event event) throws Exception {
						if (event.getName().equals("onOK")) {
							...
							categoria.setId_categoria(activar.this.categoria.getId_categoria());
							categoria.setNom_categoria(activar.this.categoria.getNom_categoria());
							categoria.setDes_categoria(activar.this.categoria.getDes_categoria());
							categoria.setId_localidad(activar.this.categoria.getId_localidad());
							categoria.setMos_marca(activar.this.categoria.getMos_marca());
							categoria.setMos_modelo(activar.this.categoria.getMos_modelo());
							categoria.setMos_serie(activar.this.categoria.getMos_serie());
							categoria.setMos_cod_activo(activar.this.categoria.getMos_cod_activo());
