...
public class desactivar extends SelectorComposer<Component> {
	...
	public void onClick$btnGrabar()
		...
		Messagebox.show("Esta seguro de desactivar el registro?", ".:: Desactivar usuario ::.",
				Messagebox.OK | Messagebox.CANCEL, Messagebox.QUESTION, new org.zkoss.zk.ui.event.EventListener() {
					...
					public void onEvent(Event event) throws Exception {
						if (event.getName().equals("onOK")) {
							...
							usuario.setId_usuario(desactivar.this.usuario.getId_usuario());
							usuario.setPas_usuario(desactivar.this.usuario.getPas_usuario());
							usuario.setNom_usuario(desactivar.this.usuario.getNom_usuario());
							usuario.setApe_usuario(desactivar.this.usuario.getApe_usuario());
							usuario.setId_perfil(desactivar.this.usuario.getId_perfil());
							usuario.setCam_password(desactivar.this.usuario.getCam_password());
							usuario.setId_localidad(desactivar.this.usuario.getId_localidad());
							usuario.setEst_usuario("IE");
							...
							try {
								...
								if (tipo == 2) {
									Messagebox.show("El usuario se desactivó correctamente.",
											".:: Desactivar usuario ::.", Messagebox.OK, Messagebox.EXCLAMATION);
								} else {
