...
public class nuevo extends SelectorComposer<Component> {
	...
	public void onBlur$txtNombre()
		...
		if (dao.consultarMarcas(0, 0, txtNombre.getText(), "", 0, 3).size() > 0) {
	...
	public void onClick$btnGrabar()
		...
		Messagebox.show("Esta seguro de guardar la marca?", ".:: Nueva marca ::.", Messagebox.OK | Messagebox.CANCEL,
				Messagebox.QUESTION, new org.zkoss.zk.ui.event.EventListener() {
					...
					public void onEvent(Event event) throws Exception {
						if (event.getName().equals("onOK")) {
							...
							marca.setUsu_ingresa(user);
							marca.setFec_ingresa(fechas.obtenerTimestampDeDate(new Date()));
							try {
								dao.insertarMarca(marca);
								Clients.showNotification("La marca se guardó correctamente.",
