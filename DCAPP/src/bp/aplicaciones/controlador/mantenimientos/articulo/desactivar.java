...
public class desactivar extends SelectorComposer<Component> {
	...
	public boolean validarSiExisteSolicitudPendienteEjecucion()
		...
		solicitud = consultasABaseDeDatos.obtenerSolicitudesxEstado("", id_mantenimiento, articulo.getId_articulo(),
				7);
		if (solicitud != null) {
	...
	public void onClick$btnGrabar()
		...
		Messagebox.show("Esta seguro de desactivar el registro?", ".:: Desactivar articulo ::.",
				Messagebox.OK | Messagebox.CANCEL, Messagebox.QUESTION, new org.zkoss.zk.ui.event.EventListener() {
					...
					public void onEvent(Event event) throws Exception {
						if (event.getName().equals("onOK")) {
							...
							articulo.setId_articulo(desactivar.this.articulo.getId_articulo());
							articulo.setId_categoria(desactivar.this.articulo.getId_categoria());
							articulo.setCod_articulo(desactivar.this.articulo.getCod_articulo());
							articulo.setDes_articulo(desactivar.this.articulo.getDes_articulo());
							articulo.setImg_articulo(desactivar.this.articulo.getImg_articulo());
							articulo.setSto_articulo(desactivar.this.articulo.getSto_articulo());
							articulo.setId_localidad(desactivar.this.articulo.getId_localidad());
							articulo.setMarca(desactivar.this.articulo.getMarca());
							articulo.setModelo(desactivar.this.articulo.getModelo());
							articulo.setSerie(desactivar.this.articulo.getSerie());
							articulo.setCodig_activo(desactivar.this.articulo.getCodig_activo());
							...
							try {
								...
								if (tipo == 2) {
									Messagebox.show("El articulo se desactivó correctamente.",
											".:: Desactivar articulo ::.", Messagebox.OK, Messagebox.EXCLAMATION);
								} else {
