...
public class activar extends SelectorComposer<Component> {
	...
	public void onClick$btnGrabar()
		...
		Messagebox.show("Esta seguro de activar el registro?", ".:: Activar capacidad ::.",
				Messagebox.OK | Messagebox.CANCEL, Messagebox.QUESTION, new org.zkoss.zk.ui.event.EventListener() {
					...
					public void onEvent(Event event) throws Exception {
						if (event.getName().equals("onOK")) {
							...
							capacidad.setId_capacidad(activar.this.capacidad.getId_capacidad());
							capacidad.setNom_capacidad(activar.this.capacidad.getNom_capacidad());
							capacidad.setDes_capacidad(activar.this.capacidad.getDes_capacidad());
							...
							try {
								...
								if (tipo == 2) {
									Messagebox.show("La capacidad se activó correctamente.",
											".:: Activar capacidad ::.", Messagebox.OK, Messagebox.EXCLAMATION);
								} else {
