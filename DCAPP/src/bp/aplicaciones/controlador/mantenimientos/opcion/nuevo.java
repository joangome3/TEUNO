...
public class nuevo extends SelectorComposer<Component> {
	...
	public void onBlur$txtNombre()
		...
		if (dao.consultarOpciones(0, 0, txtNombre.getText(), "", 0, 3).size() > 0) {
	...
	public void onClick$btnGrabar()
		...
		Messagebox.show("Esta seguro de guardar la opcion?", ".:: Nuevo opcion ::.", Messagebox.OK | Messagebox.CANCEL,
				Messagebox.QUESTION, new org.zkoss.zk.ui.event.EventListener() {
					...
					public void onEvent(Event event) throws Exception {
						if (event.getName().equals("onOK")) {
							...
							opcion.setUsu_ingresa(user);
							opcion.setFec_ingresa(fechas.obtenerTimestampDeDate(new Date()));
							try {
								dao.insertarOpcion(opcion);
								Clients.showNotification("La opcion se guardó correctamente.",
										Clients.NOTIFICATION_TYPE_INFO, dSolicitudes, "top_right", 4000);
								limpiarCampos();
							} catch (Exception e) {
								Clients.showNotification(
										"Error al guardar la opcion. \n\n" + "Mensaje de error: \n\n" + e.getMessage(),
	...
	public void onClick$btnCancelar() {
		Events.postEvent(new Event("onClose", zNuevaOpcion));
	}
