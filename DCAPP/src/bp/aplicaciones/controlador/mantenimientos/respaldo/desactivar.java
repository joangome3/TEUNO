...
public class desactivar extends SelectorComposer<Component> {
	...
	public boolean validarSiExisteSolicitudPendienteEjecucion()
		...
		solicitud = consultasABaseDeDatos.obtenerSolicitudesxEstado("", id_mantenimiento, respaldo.getId_respaldo(),
				7);
		if (solicitud != null) {
	...
	public void onClick$btnGrabar()
		...
		Messagebox.show("Esta seguro de desactivar el registro?", ".:: Desactivar respaldo ::.",
				Messagebox.OK | Messagebox.CANCEL, Messagebox.QUESTION, new org.zkoss.zk.ui.event.EventListener() {
					...
					public void onEvent(Event event) throws Exception {
						if (event.getName().equals("onOK")) {
							...
							respaldo.setId_respaldo(desactivar.this.respaldo.getId_respaldo());
							respaldo.setId_tip_respaldo(desactivar.this.respaldo.getId_tip_respaldo());
							respaldo.setDia_respaldo(desactivar.this.respaldo.getDia_respaldo());
							respaldo.setEs_fec_respaldo(desactivar.this.respaldo.getEs_fec_respaldo());
							respaldo.setEst_respaldo("IE");
							...
							try {
								...
								if (tipo == 2) {
									Messagebox.show("El respaldo se desactivó correctamente.",
											".:: Desactivar respaldo ::.", Messagebox.OK, Messagebox.EXCLAMATION);
								} else {
