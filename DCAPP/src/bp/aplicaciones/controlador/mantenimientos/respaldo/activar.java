...
public class activar extends SelectorComposer<Component> {
	...
	public void onClick$btnGrabar()
		...
		Messagebox.show("Esta seguro de activar el registro?", ".:: Activar respaldo ::.",
				Messagebox.OK | Messagebox.CANCEL, Messagebox.QUESTION, new org.zkoss.zk.ui.event.EventListener() {
					...
					public void onEvent(Event event) throws Exception {
						if (event.getName().equals("onOK")) {
							...
							respaldo.setId_respaldo(activar.this.respaldo.getId_respaldo());
							respaldo.setId_tip_respaldo(activar.this.respaldo.getId_tip_respaldo());
							respaldo.setDia_respaldo(activar.this.respaldo.getDia_respaldo());
							respaldo.setEs_fec_respaldo(activar.this.respaldo.getEs_fec_respaldo());
							...
							try {
								...
								if (tipo == 2) {
									Messagebox.show("El respaldo se activó correctamente.", ".:: Activar respaldo ::.",
											Messagebox.OK, Messagebox.EXCLAMATION);
								} else {
									Messagebox.show("No se realizaron cambios en el registro.",
											".:: Activar respaldo ::.", Messagebox.OK, Messagebox.EXCLAMATION);
								}
								limpiarCampos();
