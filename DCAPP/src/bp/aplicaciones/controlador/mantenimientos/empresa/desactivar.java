...
import bp.aplicaciones.controlador.mantenimientos.empresa.desactivar;
...
public class desactivar extends SelectorComposer<Component> {
	...
	public void onClick$btnGrabar()
		...
		Messagebox.show("Esta seguro de desactivar el registro?", ".:: Desactivar empresa ::.",
				Messagebox.OK | Messagebox.CANCEL, Messagebox.QUESTION, new org.zkoss.zk.ui.event.EventListener() {
					...
					public void onEvent(Event event) throws Exception {
						if (event.getName().equals("onOK")) {
							...
							empresa.setId_empresa(desactivar.this.empresa.getId_empresa());
							empresa.setNom_empresa(desactivar.this.empresa.getNom_empresa());
							empresa.setDes_empresa(desactivar.this.empresa.getDes_empresa());
							empresa.setEst_empresa("IE");
							...
							try {
								...
								if (tipo == 2) {
									Messagebox.show("La empresa se desactivó correctamente.",
											".:: Desactivar empresa ::.", Messagebox.OK, Messagebox.EXCLAMATION);
								} else {
