...
public class modificar extends SelectorComposer<Component> {
	...
	modelo_informativo informativo = (modelo_informativo) Sessions.getCurrent().getAttribute("informativo");
	...
	public void cargarDatos() {
		txtId.setText(String.valueOf(informativo.getId_informativo()));
		dtxFechaInicio.setValue(informativo.getFec_inicio());
		dtxFechaFin.setValue(informativo.getFec_fin());
		cEditor.setValue(informativo.getDescripcion());
		if (informativo.getSe_publica().equals("S")) {
			chkSePublica.setChecked(true);
		} else {
			chkSePublica.setChecked(false);
		}
	}
	...
	public void onClick$btnGrabar()
		...
		if (cEditor.getValue().length() <= 0) {
			Messagebox.show("Debe registrar el mensaje a mostrar en el informativo", ".:: Modificar informativo ::.",
					Messagebox.OK, Messagebox.EXCLAMATION);
			return;
		}
		Messagebox.show("Esta seguro de guardar el informativo?", ".:: Modificar informativo ::.",
				Messagebox.OK | Messagebox.CANCEL, Messagebox.QUESTION, new org.zkoss.zk.ui.event.EventListener() {
					...
					public void onEvent(Event event) throws Exception {
						if (event.getName().equals("onOK")) {
							...
							informativo.setId_informativo(Long.valueOf(txtId.getText().toString()));
							...
							try {
								dao.modificarInformativo(informativo);
								Messagebox.show("El informativo se guardó correctamente.",
										".:: Modificar informativo ::.", Messagebox.OK, Messagebox.EXCLAMATION);
								limpiarCampos();
								Sessions.getCurrent().removeAttribute("informativo");
