...
public class parametros7 extends SelectorComposer<Component> {
	...
	List<modelo_estado_articulo> listaEstado = new ArrayList<modelo_estado_articulo>();
	List<modelo_parametros_generales_7> listaRelacionEstado = new ArrayList<modelo_parametros_generales_7>();
	...
	public void cargarEstados() throws ClassNotFoundException, FileNotFoundException, IOException {
		...
		String criterio = "";
		try {
			listaEstado = dao.obtenerEstados(criterio, 1, "");
	...
	public void onClick$btnGrabar() {
		...
		if (coxEstado.getValue() == null) {
			...
			Messagebox.show("seleccione un color.", ".:: Parametros generales #7 ::.", Messagebox.OK,
					Messagebox.EXCLAMATION);
			return;
		}
		Messagebox.show("Esta seguro de guardar los parametros?", ".:: Parametros generales #7 ::.",
				Messagebox.OK | Messagebox.CANCEL, Messagebox.QUESTION, new org.zkoss.zk.ui.event.EventListener() {
					...
					public void onEvent(Event event) throws Exception {
						if (event.getName().equals("onOK")) {
							...
							dao_parametros_generales_7 dao = new dao_parametros_generales_7();
							modelo_parametros_generales_7 relacion;
							List<modelo_parametros_generales_7> listaRelacion = new ArrayList<modelo_parametros_generales_7>();
							relacion = new modelo_parametros_generales_7();
							...
							try {
								...
								Messagebox.show("Los parametros se guardaron correctamente.",
										".:: Parametros generales #7 ::.", Messagebox.OK, Messagebox.EXCLAMATION);
