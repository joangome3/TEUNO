				...
				Messagebox.OK | Messagebox.CANCEL, Messagebox.QUESTION, new org.zkoss.zk.ui.event.EventListener() {
					...
					public void onEvent(Event event) throws Exception {
						if (event.getName().equals("onOK")) {
							...
							ubicacion.setId_ubicacion(desactivar.this.ubicacion.getId_ubicacion());
							ubicacion.setId_tip_ubicacion(desactivar.this.ubicacion.getId_tip_ubicacion());
							ubicacion.setId_empresa(desactivar.this.ubicacion.getId_empresa());
							ubicacion.setPos_ubicacion(desactivar.this.ubicacion.getPos_ubicacion());
							ubicacion.setVal_capacidad(desactivar.this.ubicacion.getVal_capacidad());
							ubicacion.setCap_ubicacion(desactivar.this.ubicacion.getCap_ubicacion());
							ubicacion.setId_localidad(desactivar.this.ubicacion.getId_localidad());
							ubicacion.setUsu_modifica(user);
							java.util.Date date = new Date();
							Timestamp timestamp = new Timestamp(date.getTime());
							ubicacion.setEst_ubicacion("IE");
							...
							try {
								...
								if (tipo == 2) {
									Messagebox.show("La ubicacion se desactivó correctamente.",
											".:: Desactivar ubicacion ::.", Messagebox.OK, Messagebox.EXCLAMATION);
								} else {
