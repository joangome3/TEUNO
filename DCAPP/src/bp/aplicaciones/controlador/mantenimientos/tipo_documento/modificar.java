...
public class modificar extends SelectorComposer<Component> {
	...
	@Wire
	Window zModificarTipoDocumento;
	@Wire
	...
	modelo_tipo_documento tipo_documento = (modelo_tipo_documento) Sessions.getCurrent().getAttribute("tipo_documento");
	...
	public void cargarDatos() {
		txtId.setText(String.valueOf(tipo_documento.getId_tipo_documento()));
		txtNombre.setText(tipo_documento.getNom_tipo_documento());
	}
	...
	public void onBlur$txtNombre()
		...
		if (dao.consultarTipoDocumentos(tipo_documento.getId_tipo_documento(), 0, txtNombre.getText(), "", 0, 4)
				.size() > 0) {
	...
	public void onClick$btnGrabar()
		...
		Messagebox.show("Esta seguro de actualizar el tipo de documento?", ".:: Modificar tipo de documento ::.",
				Messagebox.OK | Messagebox.CANCEL, Messagebox.QUESTION, new org.zkoss.zk.ui.event.EventListener() {
					...
					public void onEvent(Event event) throws Exception {
						if (event.getName().equals("onOK")) {
							...
							tipo_documento = modificar.this.tipo_documento;
							tipo_documento.setNom_tipo_documento(txtNombre.getText());
							tipo_documento.setEst_tipo_documento("AE");
							...
							try {
								...
								Clients.showNotification("El tipo de documento se actualizó correctamente.",
	...
	public void onClick$btnCancelar() {
		Events.postEvent(new Event("onClose", zModificarTipoDocumento));
	}
