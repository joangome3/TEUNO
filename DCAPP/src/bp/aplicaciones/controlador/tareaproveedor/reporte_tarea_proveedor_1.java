...
public class reporte_tarea_proveedor_1 extends SelectorComposer<Component> {
	...
	public void onClick$btnConsultar() throws ClassNotFoundException, FileNotFoundException, SQLException, IOException {
		...
		try {
			reporte.setSrc("/bitacora/tarea_proveedor/reporte1/Reporte_de_actividades_programadas.jasper");
