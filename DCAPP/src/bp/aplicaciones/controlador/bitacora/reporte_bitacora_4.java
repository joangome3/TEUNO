...
public class reporte_bitacora_4 extends SelectorComposer<Component> {
	...
	public void onClick$btnConsultar() throws ClassNotFoundException, FileNotFoundException, SQLException, IOException {
		...
		try {
			reporte.setSrc("bitacora/log_eventos/reporte4/FO-PV-07 Registro servicios postventa Datacenter.jasper");
