...
public class reporte_bitacora_2 extends SelectorComposer<Component> {
	...
	public void onClick$btnConsultar() throws ClassNotFoundException, FileNotFoundException, SQLException, IOException {
		...
		try {
			reporte.setSrc("/bitacora/log_eventos/reporte2/Reporte_de_log_de_eventos_detallado.jasper");
