...
public class modelo_panel2 {
	 ...
	 * @param tipo_servicio
	 */
	public modelo_panel2(String tipo_servicio) {
		super();
	 ...
	 * @param tipo_servicio
	 */
	public modelo_panel2(int cantidad, String tipo_servicio) {
		super();
	 ...
	 * @param porcentaje
	 */
	public modelo_panel2(String cumplimiento, int cantidad, int porcentaje) {
		super();
