...
public class modelo_bitacora implements Cloneable {
	...
	public modelo_bitacora(long id_bitacora, long id_cliente, String ticket_externo, long id_turno,
			long id_tipo_servicio, long id_tipo_tarea, long id_solicitante, String descripcion, Timestamp fec_inicio,
			Timestamp fec_fin, long id_estado_bitacora, String cumplimiento, long id_localidad, String est_bitacora,
	...
	public modelo_bitacora(long id_bitacora, long id_cliente, String nom_cliente, String ticket_externo, long id_turno,
			...
			String cumplimiento, long id_localidad, String nom_localidad, String est_bitacora, String usu_ingresa,
			String nom_usuario_ingresa, Timestamp fec_ingresa, String usu_modifica, String nom_usuario_modifica,
			Timestamp fec_modifica, String cor_revisa, String nom_usuario_revisa, Timestamp fec_revision,
	...
	public String toString() {
		return "modelo_bitacora [id_bitacora=" + id_bitacora + ", id_cliente=" + id_cliente + ", nom_cliente="
				...
				+ id_solicitante + ", nom_solicitante=" + nom_solicitante + ", descripcion=" + descripcion
				...
				+ id_localidad + ", nom_localidad=" + nom_localidad + ", est_bitacora=" + est_bitacora
