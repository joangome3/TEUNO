...
public class modelo_panel4 {
	 ...
	 * @param tipo_servicio
	 */
	public modelo_panel4(String tipo_servicio) {
		super();
	 ...
	 * @param tipo_servicio
	 */
	public modelo_panel4(int cantidad, String tipo_servicio) {
		super();
	 ...
	 * @param porcentaje
	 */
	public modelo_panel4(String cumplimiento, int cantidad, int porcentaje) {
		super();
