...
//Estados
public class dao_estado_bitacora {

	public Long obtenerNuevoId() throws SQLException, ClassNotFoundException, FileNotFoundException, IOException {
		conexion conexion = new conexion();
		Long id = (long) 0;
		try {
			PreparedStatement consulta = conexion.abrir().prepareStatement("{CALL estado_bitacora_obtenerNuevoID()}");
	...
	public List<modelo_estado_bitacora> obtenerEstados(String criterio, int tipo, String localidad)
			throws SQLException, ClassNotFoundException, FileNotFoundException, IOException {
		conexion conexion = new conexion();
		List<modelo_estado_bitacora> lista_estados = new ArrayList<modelo_estado_bitacora>();
		PreparedStatement consulta = null;
		try {
			consulta = conexion.abrir().prepareStatement("{CALL estado_bitacora_obtenerEstados(?,?,?)}");
			...
			while (resultado.next()) {
				lista_estados.add(
						new modelo_estado_bitacora(resultado.getLong("id_estado"), resultado.getString("nom_estado"),
	...
	public void insertarEstado(modelo_estado_bitacora estado) throws SQLException,
		...
		try {
			PreparedStatement consulta = null;
			consulta = conexion.abrir().prepareStatement("{CALL estado_bitacora_insertarEstado(?, ?, ?, ?, ?, ?)}");
	...
	public void modificarEstado(modelo_estado_bitacora estado, modelo_solicitud solicitud, int tipo)
		...
		try {
			PreparedStatement consulta = null;
			consulta = conexion.abrir().prepareStatement("{CALL estado_bitacora_modificarEstado(?, ?, ?, ?, ?, ?, ?)}");
	...
	public void activarDesactivarEstado(modelo_estado_bitacora estado) throws SQLException,
			MySQLIntegrityConstraintViolationException, ClassNotFoundException, FileNotFoundException, IOException {
		conexion conexion = new conexion();
		try {
			PreparedStatement consulta = null;
			consulta = conexion.abrir().prepareStatement("{CALL estado_bitacora_desactivarEstado(?, ?, ?, ?)}");
	...
	public void actualizarEstado(modelo_estado_bitacora estado) throws SQLException,
			MySQLIntegrityConstraintViolationException, ClassNotFoundException, FileNotFoundException, IOException {
		conexion conexion = new conexion();
		try {
			PreparedStatement consulta = null;
			consulta = conexion.abrir().prepareStatement("{CALL estado_bitacora_actualizarEstado(?,?,?,?)}");
			consulta.setString(1, estado.getEst_estado());
			consulta.setString(2, estado.getUsu_modifica());
			consulta.setTimestamp(3, estado.getFec_modifica());
			consulta.setLong(4, estado.getId_estado());
	...
	public void eliminarEstado(Long id_estado) throws SQLException, MySQLIntegrityConstraintViolationException,
		...
		try {
			PreparedStatement consulta = null;
			consulta = conexion.abrir().prepareStatement("{CALL estado_bitacora_eliminarEstado(?)}");
