...
public class dao_relacion_articulo {
	...
	public boolean obtenerRelacionArticuloUbicacion(long id_relacion, long id_articulo, long id_ubicacion, int tipo)
		...
		modelo_relacion_articulo_ubicacion relacion = null;
		try {
			consulta = conexion.abrir().prepareStatement("{CALL relacion_obtenerRelacionesArticulos(?, ?, ?, ?)}");
			...
			while (resultado.next()) {
				relacion = new modelo_relacion_articulo_ubicacion(resultado.getLong("id_relacion"),
						resultado.getLong("id_articulo"), resultado.getLong("id_ubicacion"),
						resultado.getInt("sto_articulo"), resultado.getString("est_relacion"),
	...
	public List<modelo_relacion_articulo_ubicacion> obtenerRelacionesArticulosUbicaciones(long id_relacion, long id_articulo, long id_ubicacion, int tipo)
			throws SQLException, ClassNotFoundException, FileNotFoundException, IOException {
		conexion conexion = new conexion();
		PreparedStatement consulta = null;
		...
		try {
			...
			ResultSet resultado = consulta.executeQuery();
			while (resultado.next()) {
				listaRelacionArticulos.add(new modelo_relacion_articulo_ubicacion(resultado.getLong("id_relacion"),
						resultado.getLong("id_articulo"), resultado.getLong("id_ubicacion"),
						resultado.getInt("sto_articulo"), resultado.getString("est_relacion"),
						resultado.getString("usu_ingresa"), resultado.getTimestamp("fec_ingresa"),
						resultado.getString("usu_modifica"), resultado.getTimestamp("fec_modifica")));
	...
	public void insertarRelacion(List<modelo_relacion_articulo_ubicacion> relacion, long id_articulo)
