...
public class dao_localidad {
	...
	public List<modelo_localidad> consultarLocalidades(long id1, long id2, String criterio1, String criterio2,
		...
		try {
			...
			Query query = session.createNativeQuery("{CALL localidad_obtenerLocalidades2(?, ?, ?, ?, ?, ?)}",
			...
			lista_localidades = query.getResultList();
			transaction.commit();
		} catch (Exception e) {
			if (transaction != null) {
	...
	public void insertarLocalidad(modelo_localidad localidad) {
		Session session = null;
		Transaction transaction = null;
		try {
			session = sessionFactory.openSession();
	...
	public void actualizarLocalidad(modelo_localidad localidad) {
		Session session = null;
		Transaction transaction = null;
		try {
			session = sessionFactory.openSession();
	...
	public void eliminarLocalidad(modelo_localidad localidad) {
		Session session = null;
		Transaction transaction = null;
		try {
			session = sessionFactory.openSession();
