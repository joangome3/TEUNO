...
public class dao_tipo_servicio {
	...
	public List<modelo_tipo_servicio> obtenerTipoServicios(String criterio, int tipo, long id, int limite)
		...
		try {
			...
			ResultSet resultado = consulta.executeQuery();
			while (resultado.next()) {
				lista_tipo_servicios.add(
						new modelo_tipo_servicio(resultado.getLong("id_tipo_servicio"), resultado.getString("nom_tipo_servicio"),
								resultado.getString("des_tipo_servicio"), resultado.getString("est_tipo_servicio"),
	...
	public void insertarTipoServicio(modelo_tipo_servicio tipo_servicio) throws SQLException,
