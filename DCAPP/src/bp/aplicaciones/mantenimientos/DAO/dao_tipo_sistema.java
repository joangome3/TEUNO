...
public class dao_tipo_sistema {

	public Long obtenerNuevoId() throws SQLException, ClassNotFoundException, FileNotFoundException, IOException {
		conexion conexion = new conexion();
		Long id = (long) 0;
		try {
			PreparedStatement consulta = conexion.abrir().prepareStatement("{CALL tipo_sistema_obtenerNuevoID()}");
			ResultSet resultado = consulta.executeQuery();
			while (resultado.next()) {
				id = resultado.getLong("id_tipo_sistema") + 1;
			}
			resultado.close();
			consulta.close();
	...
	public List<modelo_tipo_sistema> obtenerTipoSistemas(String criterio, int tipo, long id, int limite)
			throws SQLException, ClassNotFoundException, FileNotFoundException, IOException {
		conexion conexion = new conexion();
		List<modelo_tipo_sistema> lista_tipo_sistemas = new ArrayList<modelo_tipo_sistema>();
		PreparedStatement consulta = null;
		try {
			consulta = conexion.abrir().prepareStatement("{CALL tipo_sistema_obtenerTipoSistemas(?, ?, ?, ?)}");
			...
			ResultSet resultado = consulta.executeQuery();
			while (resultado.next()) {
				lista_tipo_sistemas.add(
						new modelo_tipo_sistema(resultado.getLong("id_tipo_sistema"), resultado.getString("nom_tipo_sistema"),
								resultado.getString("des_tipo_sistema"), resultado.getString("est_tipo_sistema"),
		...
		return lista_tipo_sistemas;
	}

	public void insertarTipoSistema(modelo_tipo_sistema tipo_sistema) throws SQLException,
		...
		try {
			PreparedStatement consulta = null;
			consulta = conexion.abrir().prepareStatement("{CALL tipo_sistema_insertarTipoSistema(?,?,?,?,?,?)}");
			consulta.setLong(1, id);
			consulta.setString(2, tipo_sistema.getNom_tipo_sistema().toUpperCase());
			consulta.setString(3, tipo_sistema.getDes_tipo_sistema().toUpperCase());
			consulta.setString(4, tipo_sistema.getEst_tipo_sistema());
			consulta.setString(5, tipo_sistema.getUsu_ingresa());
			consulta.setTimestamp(6, tipo_sistema.getFec_ingresa());
	...
	public void modificarTipoSistema(modelo_tipo_sistema tipo_sistema, modelo_solicitud solicitud, int tipo)
		...
		try {
			PreparedStatement consulta = null;
			consulta = conexion.abrir().prepareStatement("{CALL tipo_sistema_modificarTipoSistema(?,?,?,?,?,?,?)}");
			consulta.setString(1, tipo_sistema.getNom_tipo_sistema().toUpperCase());
			consulta.setString(2, tipo_sistema.getDes_tipo_sistema().toUpperCase());
			consulta.setString(3, tipo_sistema.getEst_tipo_sistema());
			consulta.setString(4, tipo_sistema.getUsu_modifica());
			consulta.setTimestamp(5, tipo_sistema.getFec_modifica());
			consulta.setLong(6, tipo_sistema.getId_tipo_sistema());
	...
	public void actualizarEstadoTipoSistema(modelo_tipo_sistema tipo_sistema) throws SQLException,
			MySQLIntegrityConstraintViolationException, ClassNotFoundException, FileNotFoundException, IOException {
		conexion conexion = new conexion();
		try {
			PreparedStatement consulta = null;
			consulta = conexion.abrir().prepareStatement("{CALL tipo_sistema_actualizarEstadoTipoSistema(?,?,?,?)}");
			consulta.setString(1, tipo_sistema.getEst_tipo_sistema());
			consulta.setString(2, tipo_sistema.getUsu_modifica());
			consulta.setTimestamp(3, tipo_sistema.getFec_modifica());
			consulta.setLong(4, tipo_sistema.getId_tipo_sistema());
			consulta.executeUpdate();
			consulta.close();
		} catch (SQLException ex) {
			throw new SQLException(ex);
	...
	public void eliminarTipoSistema(long id_tipo_sistema, modelo_solicitud solicitud, int tipo) throws SQLException,
			MySQLIntegrityConstraintViolationException, ClassNotFoundException, FileNotFoundException, IOException {
		conexion conexion = new conexion();
		conexion.abrir().setAutoCommit(false);
		try {
			PreparedStatement consulta = null;
			consulta = conexion.abrir().prepareStatement("{CALL tipo_sistema_eliminarTipoSistema(?)}");
			consulta.setLong(1, id_tipo_sistema);
			if (tipo == 1) {
				consulta.executeUpdate();
			}
			if (solicitud.getId_mantenimiento() == 3) {
