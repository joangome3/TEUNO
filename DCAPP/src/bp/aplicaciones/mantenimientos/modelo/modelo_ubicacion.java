...
public class modelo_ubicacion {
   ...
   * @param fec_modifica
   */
  public modelo_ubicacion(long id_ubicacion, long id_empresa, long id_tip_ubicacion, String pos_ubicacion,
		long id_localidad, String est_ubicacion, String usu_ingresa, Timestamp fec_ingresa, String usu_modifica,
   ...
   * @param fec_modifica
   */
  public modelo_ubicacion(long id_ubicacion, long id_empresa, String nom_empresa, long id_tip_ubicacion,
		String nom_ubicacion, String pos_ubicacion, long id_localidad, String nom_localidad, String est_ubicacion,
  ...
  public String toString() {
	 return "modelo_ubicacion [id_ubicacion=" + id_ubicacion + ", id_empresa=" + id_empresa + ", nom_empresa="
		  ...
		  + ", pos_ubicacion=" + pos_ubicacion + ", id_localidad=" + id_localidad + ", nom_localidad=" + nom_localidad
  ...
  /* Se sobreescribe el metodo toString */
	...
	public boolean validarSiExisteSolicitudCreada()
		...
		solicitud = consultasABaseDeDatos.obtenerSolicitudesxEstado("", 2, id_ubicacion, 7);
		if (solicitud != null) {
	...
	public boolean validarSiExisteSolicitudCerrada()
		...
		modelo_solicitud solicitud = new modelo_solicitud();
		solicitud = consultasABaseDeDatos.obtenerSolicitudesxEstado("", 2, id_ubicacion, 9);
		if (solicitud != null) {
			String estado = solicitud.getEst_solicitud();
			if (estado != null) {
