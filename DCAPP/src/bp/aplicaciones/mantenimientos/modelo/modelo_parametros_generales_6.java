...
public class modelo_parametros_generales_6 {
	 ...
	 * 
	 */
	public modelo_parametros_generales_6() {
		super();
	}
	 ...
	 * @param fec_modifica
	 */
	public modelo_parametros_generales_6(long id_relacion, long id_criticidad, String nom_criticidad, String color,
	...
	public String toString() {
		return "modelo_parametros_generales_6 [id_relacion=" + id_relacion + ", id_criticidad=" + id_criticidad
				+ ", nom_criticidad=" + nom_criticidad + ", color=" + color + ", id_localidad=" + id_localidad
