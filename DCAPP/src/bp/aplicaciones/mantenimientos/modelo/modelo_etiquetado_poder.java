...
@Entity
@Table(name = "nocap_etiquetado_poder")
public class modelo_etiquetado_poder {

	@Id
	@Column(name = "id_etiqueta_poder", nullable = false)
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	private long id_etiqueta_poder;
	 ...
	 * 
	 */
	public modelo_etiquetado_poder() {
	}
	 ...
	 * @param fec_modifica
	 */
	public modelo_etiquetado_poder(String nom_etiqueta, String est_etiqueta, String usu_ingresa, Timestamp fec_ingresa,
	 ...
	 * @param fec_modifica
	 */
	public modelo_etiquetado_poder(long id_etiqueta_poder, String nom_etiqueta, String est_etiqueta, String usu_ingresa,
			Timestamp fec_ingresa, String usu_modifica, Timestamp fec_modifica) {
		super();
		this.id_etiqueta_poder = id_etiqueta_poder;
		this.nom_etiqueta = nom_etiqueta;
		this.est_etiqueta = est_etiqueta;
		this.usu_ingresa = usu_ingresa;
		this.fec_ingresa = fec_ingresa;
	...
	/**
	 * @return the id_etiqueta_poder
	 */
	public long getId_etiqueta_poder() {
		return id_etiqueta_poder;
	}

	/**
	 * @param id_etiqueta_poder the id_etiqueta_poder to set
	 */
	public void setId_etiqueta_poder(long id_etiqueta_poder) {
		this.id_etiqueta_poder = id_etiqueta_poder;
	}
	...
	public String toString() {
		return "modelo_etiquetado_poder [id_etiqueta_poder=" + id_etiqueta_poder + ", nom_etiqueta=" + nom_etiqueta
