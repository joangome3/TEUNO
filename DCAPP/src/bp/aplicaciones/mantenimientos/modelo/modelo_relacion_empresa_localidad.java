...
public class modelo_relacion_empresa_localidad {
   ...
   * @param fec_modifica
   */
  public modelo_relacion_empresa_localidad(long id_relacion, long id_empresa, long id_localidad, String est_relacion,
  ...
  public String toString() {
	 return "modelo_relacion_empresa_localidad [id_relacion=" + id_relacion + ", id_empresa=" + id_empresa
