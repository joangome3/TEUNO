...
public class modelo_relacion_solicitante_opcion {
   ...
   * @param fec_modifica
   */
  public modelo_relacion_solicitante_opcion(long id_relacion, long id_solicitante, long id_opcion, String est_relacion,
  ...
  public String toString() {
	 return "modelo_relacion_solicitante_opcion [id_relacion=" + id_relacion + ", id_solicitante=" + id_solicitante + ", id_opcion="
		  + id_opcion + ", est_relacion=" + est_relacion + ", usu_ingresa=" + usu_ingresa + ", fec_ingresa=" + fec_ingresa
