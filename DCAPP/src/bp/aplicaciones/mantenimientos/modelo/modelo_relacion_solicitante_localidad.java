...
public class modelo_relacion_solicitante_localidad {
   ...
   * @param fec_modifica
   */
  public modelo_relacion_solicitante_localidad(long id_relacion, long id_solicitante, long id_localidad, String est_relacion,
  ...
  public String toString() {
	 return "modelo_relacion_solicitante_localidad [id_relacion=" + id_relacion + ", id_solicitante=" + id_solicitante
