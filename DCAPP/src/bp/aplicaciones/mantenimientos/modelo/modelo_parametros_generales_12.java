...
public class modelo_parametros_generales_12 {

	private long id_relacion;
	private long id_empresa;
	private String nom_empresa;
	private long id_opcion;
	private String se_acepta_ticket_repetido;
	 ...
	 * 
	 */
	public modelo_parametros_generales_12() {
		super();
	}
	 ...
	 * @param nom_empresa
	 * @param id_opcion
	 * @param se_acepta_ticket_repetido
	 * @param id_localidad
	 * @param est_relacion
	 * @param usu_ingresa
	 * @param fec_ingresa
	 ...
	 * @param fec_modifica
	 */
	public modelo_parametros_generales_12(long id_relacion, long id_empresa, String nom_empresa, long id_opcion,
			String se_acepta_ticket_repetido, long id_localidad, String est_relacion, String usu_ingresa,
		...
		this.se_acepta_ticket_repetido = se_acepta_ticket_repetido;
	...
	/**
	 * @return the se_acepta_ticket_repetido
	 */
	public String getSe_acepta_ticket_repetido() {
		return se_acepta_ticket_repetido;
	}

	/**
	 * @param se_acepta_ticket_repetido the se_acepta_ticket_repetido to set
	 */
	public void setSe_acepta_ticket_repetido(String se_acepta_ticket_repetido) {
		this.se_acepta_ticket_repetido = se_acepta_ticket_repetido;
	}
	...
	public String toString() {
		return "modelo_parametros_generales_12 [id_relacion=" + id_relacion + ", id_empresa=" + id_empresa
				+ ", nom_empresa=" + nom_empresa + ", id_opcion=" + id_opcion + ", se_acepta_ticket_repetido="
				+ se_acepta_ticket_repetido + ", id_localidad=" + id_localidad + ", est_relacion=" + est_relacion
