...
public class modelo_relacion_solicitante_mantenimiento {
  ...
  public String toString() {
	 return "modelo_relacion_solicitante_mantenimiento [id_relacion=" + id_relacion + ", id_solicitante=" + id_solicitante
   ...
   * @param fec_modifica
   */
  public modelo_relacion_solicitante_mantenimiento(long id_relacion, long id_solicitante, long id_mantenimiento,
