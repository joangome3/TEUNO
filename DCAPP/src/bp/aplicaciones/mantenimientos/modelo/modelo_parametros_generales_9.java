...
public class modelo_parametros_generales_9 {

	private long id_relacion;
	private long id_empresa;
	private String nom_empresa;
	private String nom_ticket;
	private int cant_caracteres;
	 ...
	 * 
	 */
	public modelo_parametros_generales_9() {
		super();
	}
	 ...
	 * @param fec_modifica
	 */
	public modelo_parametros_generales_9(long id_relacion, long id_empresa, String nom_empresa, String nom_ticket,
			int cant_caracteres, long id_localidad, String est_relacion, String usu_ingresa, Timestamp fec_ingresa,
	...
	/**
	 * @param nom_ticket the nom_ticket to set
	 */
	...
	/**
	 * @return the cant_caracteres
	 */
	public int getCant_caracteres() {
		return cant_caracteres;
	}

	/**
	 * @param cant_caracteres the cant_caracteres to set
	 */
	public void setCant_caracteres(int cant_caracteres) {
		this.cant_caracteres = cant_caracteres;
	}
	...
	public String toString() {
		return "modelo_parametros_generales_9 [id_relacion=" + id_relacion + ", id_empresa=" + id_empresa
				+ ", nom_empresa=" + nom_empresa + ", nom_ticket=" + nom_ticket + ", cant_caracteres=" + cant_caracteres
