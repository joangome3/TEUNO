...
public class modelo_relacion_empresa_opcion {
   ...
   * @param fec_modifica
   */
  public modelo_relacion_empresa_opcion(long id_relacion, long id_empresa, long id_opcion, String est_relacion,
  ...
  public String toString() {
	 return "modelo_relacion_empresa_opcion [id_relacion=" + id_relacion + ", id_empresa=" + id_empresa + ", id_opcion="
